...
function buildWalls(): string[] {
  ...
  // ── Batas atas & bawah lantai 1 ──────────────────────────────────────────
  row(55, 1, 321);   // dinding atas lantai 1
  row(118, 1, 321);  // dinding bawah lantai 1
  ...
  row(80, 159, 180); // dinding bawah c159–180 (nolabel3/4, dfree1)
  ...
  col(121, 81, 95);  // dinding kanan toilet2/3

  // ── Area nolabel12–14 (l1_nl12–14): r74–r78 c169–c192 ───────────────────
  col(167, 74, 79);

  // ── Area tangga1/2 (l1_ld1/2) + nolabel20/21: r92–r107 c122–c128 ────────
  row(96, 119, 132); // dinding atas tangga area c119–c131
  row(100, 121, 127);
  row(106, 121, 127);
  col(121, 101, 105);
  col(127, 101, 105);
  row(104, 106, 120); // dinding atas area c106–c120

  // ── Area besar bawah L1: r104–r113 c56–c84 ───────────────────────────────
  // food3 (l1_fnb3): r103–r106 c66–c75
  row(104, 56, 84);  // dinding atas blok bawah kiri
  ...
  row(108, 18, 49);
  col(17, 104, 112); // dinding kanan musholla2/3 + toilet5
  row(113, 1, 50);   // dinding bawah blok toilet4/mus2/food2
  row(113, 55, 75);  // dinding bawah blok c55–c75
  row(113, 80, 100); // dinding bawah blok c80–c100
  row(113, 105, 125); // dinding bawah blok c105–c125
  row(113, 130, 190); // dinding bawah blok c130–c190
  ...
  row(109, 188, 320);
  row(108, 1, 13);   // dinding atas toilet4/mus2 area
  row(101, 1, 13);   // dinding tengah area tangga1/2
  ...
  col(188, 103, 109);
  col(190, 73, 96);  // ← col ini yang bikin sv5 conflict di c190
  row(96, 190, 320); // dinding batas bawah area kanan L1
  col(185, 73, 78);
  col(169, 83, 84);
  col(169, 86, 88);
  col(169, 90, 96);
  ...
  col(49, 7, 16);    // dinding kanan area toilet1 L2
  row(16, 1, 55);    // dinding bawah area kiri L2

  // ── Area nolabel1 L2 (l2_nl1): r33–r38 c(-1)–c3 ─────────────────────────
  // + tangga1/2 L2 (l2_ld1/2): r29–r33 c13–c20
  // + tangga3 L2 (l2_ld3): r34–r38 c4–c13
  row(44, 1, 10);    // dinding batas area pojok kiri L2
  col(15, 33, 39);   // dinding kanan tangga1/2 area
  col(15, 42, 48);

  // ── Batas area kiri bawah L2: r32–r36 c1–c20 ────────────────────────────
  row(36, 1, 15);
  row(32, 15, 20);
  row(34, 20, 75);   // dinding bawah area retail/food L2 c20–c75
  row(33, 20, 20);   // sekat satu cell
  ...
  row(14, 111, 118); // dinding atas area toilet3/4 L2
  ...
  col(118, 8, 9);
  col(118, 11, 34);
  row(34, 118, 160); // ← dinding ini yang bikin lounge1 L2 conflict
  col(160, 14, 34);
  ...
  row(4, 53, 56);    // sisi gate1
  row(4, 60, 72);    // antara gate1 dan gate2
  row(4, 76, 79);    // sisi gate2
  row(4, 83, 172);   // c83–c172 (gate3, musholla2, area tengah)

  // ── Batas atas grid L2: r1 c53–c172 ─────────────────────────────────────
  // + gate7/8/9/10/11 (r0–r2)
  row(1, 53, 172);
  col(172, 2, 3);    // sisi kanan gate11 area
  col(53, 2, 3);     // sisi kiri gate7 area
