...
interface AdminSearchModalProps {
  /** Dipanggil saat user klik fasilitas — buka EditFacilityModal dengan data ini */
...
export default function AdminSearchModal({ onEdit }: AdminSearchModalProps) {
  ...
  // Klik fasilitas → langsung buka EditFacilityModal (tidak ada action menu)
        ...
        >
          ...
          >
            <div className="overflow-y-auto h-55 p-2 pr-1 [&::-webkit-scrollbar]:hidden">
              ...
              {/* Hasil — identik dengan SearchModal user */}
